...
function acs_ListBulkActionClick(formName, url) {
  ...
  //add an extra optional parameter for a function to execute before submitting
  if (typeof(acs_ListBulkActionClick_ExtraFunc) == 'function') {
	  if (acs_ListBulkActionClick_ExtraFunc(form) === false) {
		  return false;
	  }
  }
